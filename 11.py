...
#Date of creation: 17/1/2017

import time
#Recording start time of the program
start=time.time()
#Creating the grid and populating it with the data given in the question.
grid=[]
...
#print(grid)#This is just to see the grid.
#A vairable to store the largest product
max_product=0
#iterating through the gird and finding the product
print("Checking for left-right and up-down products..........")
for i in range(20):
    for j in range(16):
        ...
        if product>max_product:
            max_product=product
print("Checking for diagonal products........................")
for i in range(16):
    for j in range(16):
